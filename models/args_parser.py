...
def args_parser():
    ...
    parser.add_argument('--client_weights', nargs='+', type=float, default=None,
    ...
    parser.add_argument('--coeff_mod_bit_sizes', nargs='+', type=int, default=[40, 20, 40],
    ...
    parser.add_argument('--create_galois_keys', dest='create_galois_keys', action='store_true',
    ...
    parser.add_argument('--no_galois_keys', dest='create_galois_keys', action='store_false',
